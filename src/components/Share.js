    ...
    return (
      <div className="Block Block--Share Share">
        ...
        <div className="Block__Content Share__Options">
          <Twitter text="The State Of JavaScript: take the survey and help us find out the latest JavaScript trends https://stateofjs.com #StateOfJS" />
          <Facebook link="https://stateofjs.com" />
          <Email
            subject="The State Of JavaScript"
            body="The State Of JavaScript: take the survey and help us find out the latest JavaScript trends https://stateofjs.com"
          />
        </div>
      </div>
    )
